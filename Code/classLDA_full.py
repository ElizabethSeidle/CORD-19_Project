...
#############################
#147 clusterFiftyTen
#14  clusterHundredTwo
for cluster in range(147):
...
#############################
    ...
    cleaned = a_1017['abstract'].apply(nltk.word_tokenize)
    ...
    db.clusterFiftyTen.update_many({"labels": cluster_label}, {"$set": {"words": topic_list[0][0]}})
